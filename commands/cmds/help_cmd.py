...
async def help_cmd(interaction: discord.Interaction):
    ...
    e3.add_field(
        name="📖 The guide",
        value=("**/guide** → pick a raid.\n"
               "**Ghastly Conspiracy** → Right Side, Left Side, or Basics & "
               "gear: role decks, a school-picker left-side deck, "
               "turn-by-turn fight tables (dice, 2v2, bosses), gear guides, "
               "and stat caps. Credit: K31Z, DHMO, FriedChicken935 & MJ — "
               "SGD Guild.\n"
               "**Blighted Veil** → Inside team (Strategy 1 & 2 — Onis, "
               "Roots, decks, Dryads), Outside team (North / East / South / "
               "West), callouts, and gear for every role. Credit: Roaring "
               "Raptors & Battling Giraffes."),
        inline=False)
